...
<body>
    <form action="procesador.php" method="GET" >
        ...
        <label for="">ponderacion1</label>
        <input type="text" name="ponderacion1"> <br> <br>


        <label for="">nota2=</label>
        <input type="text" name="nota2"> <br> <br>

        <label for="">ponderacion2</label>
        <input type="text" name="ponderacion2"> <br> <br>

        <label for="">nota3=</label>
        <input type="text" name="nota3"> <br> <br>

        <label for="">ponderacion3</label>
        <input type="text" name="ponderacion3"> <br> <br>

        <label for="">nota4=</label>
        <input type="text" name="nota4"> <br> <br>

        <label for="">ponderacion4</label>
        <input type="text" name="ponderacion4"> <br> <br>
